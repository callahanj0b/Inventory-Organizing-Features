    ...
    internal class PostGridSortPanelShow : ModulePatch
    {
        ...
        private static void PatchPostfix(GridSortPanel __instance, InventoryController controller, CompoundItem item, Button ____button)
        {
            try
            {
                ...
                PatchForOtherCases(__instance: __instance, controller, item, ____button);
            }
            catch (Exception ex)
            {
        ...
        private static void PatchForSimpleStashPanel(GridSortPanel _instance, InventoryController controller, CompoundItem item, Button ____button)
        {
